...
func UsChat(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "GET" {
		tpl := template.Must(
			template.ParseFiles("./tpl/navbar.html", "./tpl/chat/user.html", "./tpl/base.html"),
		)
...
func DetGr(w http.ResponseWriter, r *http.Request) {
	if r.Method == "GET" {
		...
		tpl := template.Must(
			template.ParseFiles("./tpl/navbar.html", "./tpl/chat/detail.html", "./tpl/base.html"),
		)
...
func HomeChat(w http.ResponseWriter, r *http.Request) {
	if r.Method == "GET" {
		tpl := template.Must(
			template.ParseFiles("./tpl/navbar.html", "./tpl/chat/index.html", "./tpl/base.html"),
		)
